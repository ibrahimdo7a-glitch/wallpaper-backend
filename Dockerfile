...
CMD php artisan migrate --force && php artisan package:discover --ansi && php artisan db:seed --class=DefaultCategoriesSeeder --force && php artisan serve --host=0.0.0.0 --port=${PORT:-8080}
