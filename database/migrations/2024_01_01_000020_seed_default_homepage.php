...
/**
 * Seeds default homepage data automatically on deploy.
 * Idempotent — only inserts when each table is empty, so admin edits are never wiped.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (NavigationItem::count() === 0) {
            $nav = [
                ...
                ['label_ar' => 'حول الموقع', 'label_en' => 'About',     'url' => '/about',     'icon' => 'ℹ️', 'sort_order' => 7],
            ];
            foreach ($nav as $item) {
        ...
        if (HomepageSection::count() === 0) {
            $sections = [
                ['name' => 'Hero Section',   'type' => 'hero',                'layout' => 'grid',       'sort_order' => 1, 'settings' => null],
                ['name' => 'شريط الماركات',  'type' => 'brands',              'layout' => 'carousel',   'sort_order' => 2, 'title_ar' => 'الماركات', 'title_en' => 'Brands', 'settings' => ['limit' => 20]],
                ['name' => 'الإحصائيات',      'type' => 'statistics',          'layout' => 'grid',       'sort_order' => 3, 'settings' => []],
                ['name' => 'الأكثر تميزاً',   'type' => 'featured_wallpapers', 'layout' => 'hero_cards', 'sort_order' => 4, 'title_ar' => 'الأكثر تميزاً', 'title_en' => 'Featured', 'settings' => ['limit' => 8]],
                ['name' => 'آخر الأخبار',     'type' => 'news',                'layout' => 'cards',      'sort_order' => 5, 'title_ar' => 'آخر الأخبار', 'title_en' => 'Latest News', 'settings' => ['limit' => 6, 'featured_only' => false]],
                ['name' => 'مميزات الموقع',   'type' => 'custom_content',      'layout' => 'grid',       'sort_order' => 6, 'settings' => [
                    'items' => [
                        ...
                        ['icon' => '⚡', 'title_ar' => 'تحميل سريع',     'title_en' => 'Fast Downloads',   'subtitle_ar' => 'خوادم سريعة لتحميل الملفات',     'subtitle_en' => 'Fast servers for downloads'],
    ...
    {
        // Non-destructive — leave seeded data in place on rollback.
    }
};
